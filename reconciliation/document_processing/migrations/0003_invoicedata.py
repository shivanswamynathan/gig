    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source_grn_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='document_processing.itemwisegrn', verbose_name='Source GRN Record')),
            ],
            options={
